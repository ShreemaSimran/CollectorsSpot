...
<h1 style="color:white;"><center>Collectors $pot</center></h1>
	...
	<div class="splitr right">
		<div style="background:white;">
				<center><h2><I>Welcome  To  Collector's Spot  </h2></I>
		...
		<div style="background:#ECF0F3; width:80%; margin-left:10%;"  >
				<br/><center><h3>My Collection </h3></center><br/>
				<?php 
				   ...
				   if($num>0)
				   {
					   ...
					   while($rows=mysqli_fetch_assoc($res))
					   {
							   ...
							   echo"</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>";
							   echo"<h5>CATEGORY: ".$rows["category"]."<br/>NAME: ".$rows["name"]."<br/>COUNTRY: ".$rows["country"]."<br/>PRICE: ₹ ".$rows["price"]."<br/></h5>";
							   echo"</td></tr>";
		...
		<div style="background-color:#000000; height:120px; font-color:#ffffff;margin-top:10px;">
			  ...
			  <tr>
				  ...
				  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <td>
					 <h4><a href="add.php">My Exchangeables</h4>
					 <ul>
